...
for freq in range(int(0.3e6), int(1.1e6), int(0.1e6)):  # Шаг 0.1 ГГц
    set_signal_generator(ANAPICO, 2, freq, -20)  # Установка генератора
    time.sleep(0.1)
...
filename = f"Anapico_1MHz_200MHz_30db_att{timestamp}.mat"
